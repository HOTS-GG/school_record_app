              ...
              <template v-else>
                ...
                <div class="col-actions action-btns">
                  ...
                  <button class="btn-icon" @click="deleteRule(rule.id)" title="삭제">
                    <Trash2 :size="15" color="var(--clr-red-text)"/>
                  </button>
                </div>
              </template>
            </div>
...
.toggle-btn--on {
  background-color: rgba(var(--clr-green-bright-rgb), 0.15);
  color: var(--clr-green-bright);
}

.toggle-btn--off {
  background-color: rgba(var(--tx-4), 0.15);
  color: var(--tx-4);
}
...
.btn-confirm:hover {
  background-color: rgba(var(--clr-green-bright-rgb), 0.1) !important;
}

.btn-cancel {
  color: var(--clr-red-text) !important;
}

.btn-cancel:hover {
  background-color: var(--clr-red-bg) !important;
}
...
.btn-apply {
  ...
  border-radius: 8px;
  border: none;
  background-color: rgba(var(--clr-green-bright-rgb), 0.18);
  color: var(--clr-green-bright);
  font-size: 15px;
  cursor: pointer;
  font-weight: 600;
...
.btn-apply:hover:not(:disabled) {
  background-color: rgba(var(--clr-green-bright-rgb), 0.28);
}
...
.empty-preview--no-result {
  ...
  gap: 8px;
  padding: 36px 18px;
  border-color: rgba(var(--clr-green-rgb), 0.2);
  background-color: rgba(var(--clr-green-bright-rgb), 0.03);
}
...
.snapshot-notice {
  ...
  border-radius: 6px;
  border: 1px solid var(--clr-warn-bg);
}
