...
.preview-table td {
  padding: 7px 12px;
  color: var(--tx-2);
  border-bottom: 1px solid rgba(var(--bd-1-rgb), 0.7);
  white-space: nowrap;
  max-width: 200px;
  overflow: hidden;
...
.type-badge--b {
  ...
  border-color: rgba(var(--clr-warn-rgb), 0.4);
}
...
.diff-stat--new {
  ...
  border-color: rgba(var(--clr-green-rgb), 0.3);
}
...
.diff-item-header {
  ...
  padding: 10px 14px;
  background: var(--clr-warn-bg);
  border-bottom: 1px solid var(--clr-warn-bg);
}
