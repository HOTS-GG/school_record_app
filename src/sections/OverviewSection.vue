...
const steps = [
  ...
  },
  {
    ...
    bg: 'rgba(var(--clr-green-rgb), 0.07)',
    border: 'rgba(var(--clr-green-rgb), 0.25)',
  },
]
        ...
        <div class="area-box">
          ...
          <div class="activities-grid">
            ...
            <div class="activity-card activity-card--more">
              ...
              <div class="activity-info">
                <div class="activity-name" style="color:var(--tx-4);">활동 더 추가 가능</div>
...
/* ── Area 박스 다이어그램 ────────────────────────────────────── */
.area-box {
  border: 2px solid rgba(var(--clr-purple-rgb), 0.35);
  border-radius: 20px;
  background: rgba(var(--clr-purple-rgb), 0.04);
  padding: 28px 32px;
  display: flex;
  flex-direction: column;
  gap: 20px;
...
.area-tag {
  ...
  letter-spacing: 0.06em;
  color: var(--clr-purple-text);
  background: rgba(var(--clr-purple-rgb), 0.16);
  border: 1px solid rgba(var(--clr-purple-rgb), 0.35);
  border-radius: 6px;
  padding: 4px 12px;
}
...
.role-badge--homeroom {
  color: var(--clr-green-text);
  background: rgba(var(--clr-green-rgb), 0.12);
  border: 1px solid rgba(var(--clr-green-rgb), 0.3);
}
...
.mapping-key--area {
  color: var(--clr-purple-text);
  background: rgba(var(--clr-purple-rgb), 0.12);
  border: 1px solid rgba(var(--clr-purple-rgb), 0.3);
}
...
/* 공통 uc-area 박스 */
.uc-area-box {
  border: 2px solid rgba(var(--clr-purple-rgb), 0.3);
  border-radius: 16px;
  background: rgba(var(--clr-purple-rgb), 0.04);
  padding: 22px 24px;
  display: flex;
...
.uc-area-tag--subject {
  color: var(--clr-warn-text);
  background: var(--clr-warn-bg);
  border-color: rgba(var(--clr-warn-rgb), 0.35);
}
...
.usecase-tip {
  ...
  border: 1px solid rgba(var(--clr-green-rgb), 0.18);
  border-left: 3px solid var(--clr-green-text);
  border-radius: 8px;
  padding: 14px 18px;
  line-height: 1.75;
}
...
.usecase-tip--subject {
  background: var(--clr-warn-bg);
  border-color: var(--clr-warn-bg);
  border-left-color: var(--clr-warn-text);
}
