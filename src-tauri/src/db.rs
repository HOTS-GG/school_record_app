...
const MIGRATIONS: &[&str] = &[
    ...
    // v6 → v7: AreaActivity에 sort_order 컬럼 추가 (활동 순서 저장)
    "ALTER TABLE AreaActivity ADD COLUMN sort_order INTEGER NOT NULL DEFAULT 0;",
    // v7 → v8: ReplaceRule에 note 컬럼 추가 + 기본 정규식 규칙 설명 삽입
